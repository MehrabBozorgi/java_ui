...
public class ForYouFoodDetailAdapter extends RecyclerView.Adapter<ForYouFoodDetailAdapter.MyViewHolder> {

    Context context;
    List<Food> data;

    public ForYouFoodDetailAdapter(Context context, List<Food> data) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_for_food_2 , parent , false);
